      ...
      <div className="relative max-w-lg w-full bg-white bg-opacity-90 backdrop-blur-md rounded-lg shadow-lg p-8 mx-4">
        ...
        >
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-slate-600 text-white font-semibold rounded-md hover:opacity-95"
              >
                Add
              </button>
            </div>
          ...
          <div>
            ...
            <label
              htmlFor="file-upload"
              className="block text-center px-4 py-2 bg-slate-600 text-white font-semibold rounded-md cursor-pointer hover:opacity-95"
            >
              Choose Files
            </label>
            <input
